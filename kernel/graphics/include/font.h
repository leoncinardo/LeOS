...
static const uint16_t fontCharMask[] = {128, 64, 32, 16, 8, 4, 2, 1};

// Font took from https://files.osdev.org/mirrors/geezer/osd/graphics/modes.c
static const uint8_t g_8x16_font[4096] = {
